"""General-purpose data processing utilities for strategy analysis."""
from typing import Sequence

import numpy as np

from src.constants import SUMMARY_PERCENTILES
...
def build_bucket_breakdown(
    ...
    """Build bucket count rows for display tables (Range, Count, % of Total, Avg)."""
    total = len(values)
    rows = []
