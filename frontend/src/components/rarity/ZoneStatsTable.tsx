          ...
          {stats.map(row => {
            ...
            return (
              ...
              >
                ...
                <td className="py-2 px-3 text-right text-foreground">{row.count}</td>
                <td className="py-2 px-3 text-right text-foreground">{row.qr_count}</td>
                <td className="py-2 px-3 text-right text-foreground">{fmtPct(row.qr_pct)}</td>
                <td className="py-2 px-3 text-center text-muted-foreground">{row.count_5y}/{row.qr_5y}</td>
                <td className="py-2 px-3 text-center text-muted-foreground">{row.count_10y}/{row.qr_10y}</td>
                <td className="py-2 px-3 text-right text-foreground">{Math.round(row.avg_days)}</td>
                <td className="py-2 px-3 text-right text-foreground">{fmtPct(row.mmae_pct)}</td>
                {MAE_COLS.map(p => (
                  <td key={p} className="py-2 px-3 text-right text-muted-foreground">
