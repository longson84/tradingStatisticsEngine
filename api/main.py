...
from api.routes import backtest, companies, events, factors, fundamentals, market_data, market_health, sweep, symbol_lists
...
app.include_router(symbol_lists.router)
